...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupListView(){
        ...
        Log.d(TAG, "ListView adapter setup completed")
    }
    ...
    override fun onResume() {
        super.onResume()
        Log.d(TAG, "onResume: Currect student count: ${studentList.size}")
    }
    override fun onPause() {
        super.onPause()
        Log.d(TAG, "onPause: Saving student state with: ${studentList.size}")
    }
}